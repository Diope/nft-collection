...
const App = () => {
  ...
  const checkIfWalletIsConnected = async () => {
    ...
    if (!ethereum) {
      ...
      console.log("We ethereum object", ethereum);
    }
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <p className="header gradient-text">Illustrious NFT CLTN</p>
          <p className="sub-text">
            Each unique. Each beautiful. Discover your NFT today.
          </p>
          {currentAccount === "" ? renderNotConnectedContainer() : renderMiniUI()}
          <br />
          <br />
          <button className="cta-button opensea-button" onClick={linkAd}>See The Collection</button>
        </div>
